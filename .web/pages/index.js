...
export function Table__body_fe5dc0f1ffd9c1b4c048c2a99300a728 () {
...
{},
reflex___state____state__customer_data___backend___backend____state.paginated_users.map((user,index_cfc4417e0be85a86)=>(jsx(
RadixThemesTable.Row,
{align:"center",css:({ ["&:hover"] : ({ ["background"] : "var(--gray-3)" }) }),key:index_cfc4417e0be85a86},
jsx(
...
RadixThemesTable.Cell,
{},
((isNotNullOrUndefined((isTrue(user["level"]) ? user["level"] : null)) && !(((isTrue(user["level"]) ? user["level"] : null) === ""))) ? (((isTrue(user["level"]) ? user["level"] : null) === "_NO_LEVEL_") ? "\u0628\u062f\u0648\u0646 \u0633\u0637\u062d / \u0646\u0627\u0645\u0634\u062e\u0635" : (isTrue(user["level"]) ? user["level"] : null).replaceAll("level_", "\u0633\u0637\u062d ")) : "\u062a\u0639\u06cc\u06cc\u0646 \u0646\u0634\u062f\u0647")
,),jsx(
RadixThemesTable.Cell,
{},
...
RadixThemesSelect.Content,
{},
reflex___state____state__customer_data___backend___auth_state____auth_state.level_options_for_dropdown.map((opt,index_e09b3887a9fbe362)=>(jsx(
RadixThemesSelect.Item,
{key:index_e09b3887a9fbe362,value:opt.at(1)},
opt.at(0)
,))),),),),),jsx(
RadixThemesFlex,
...
export function Grid_02b0f379ed17b56f22bd75aa55a631b3 () {
...
{as:"p"},
""
,),),),),),reflex___state____state__customer_data___backend___auth_state____auth_state.allowed_levels_for_current_referral.map((level_key,index_411eb2ac23b26d34)=>(jsx(
Fragment,
{key:index_411eb2ac23b26d34},
...
,),),jsx(Grid_02b0f379ed17b56f22bd75aa55a631b3,{},)
,jsx(
RadixThemesBox,
{css:({ ["width"] : "100%" })},
jsx(
...
{as:"p"},
"\u0639\u0645\u0644\u06cc\u0627\u062a"
,),),),),),jsx(Table__body_fe5dc0f1ffd9c1b4c048c2a99300a728,{},)
,),jsx(
RadixThemesFlex,
