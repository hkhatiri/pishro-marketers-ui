...
def stats_cards_group() -> rx.Component:
    return rx.flex(
        stats_card(
            "Total Users",
            State.current_month_values.num_users,
            State.previous_month_values.num_users,
            State.users_change,
            "users",
            "blue",
        ),
        stats_card(
            "Active Users",
            State.current_month_values.num_active,
            State.previous_month_values.num_active,
            State.active_users_change,
            "user-check",
            "green",
        ),
        spacing="5",
